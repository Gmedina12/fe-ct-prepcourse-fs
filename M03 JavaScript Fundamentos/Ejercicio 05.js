...
function esPositivo(num) {
 ...
 console.log(combinarNombres("Gina Paola", "Medina"));
 ...
 console.log(obtenerSaludo("Gina Paola"));
 
 
 function obtenerAreaRectangulo(alto, ancho) {
    // Retornar el área de un rectángulo teniendo su altura y ancho.
    return alto * ancho + " m^2";
 }
 
 console.log(obtenerAreaRectangulo(5, 12));
 ...
 function areaDelTriangulo(base, altura) {
    ...
    return (base * altura) / 2 + " m^2";
 }
 
 console.log(areaDelTriangulo(5, 3));
 ...
 function esVocal(letra) {
   ...
   console.log(esVocal("oi"));
   console.log(esVocal("gato"));
